      ...
      <body>
        ...
        <nav>
          ...
          <div className="nav-right">
            ...
            <a href="https://slack.com/oauth_v2/authorize?client_id=10708640313204.10701649677509&scope=channels:history,chat:write,commands,im:write,users:read&redirect_uri=https://decisionslog.space" className="nav-cta">
        ...
        <footer>
          ...
          <div className="footer-links">
            <a href="/blog">Blog</a>
            <a href="/">Home</a>
            <a href="https://slack.com/oauth_v2/authorize?client_id=10708640313204.10701649677509&scope=channels:history,chat:write,commands,im:write,users:read&redirect_uri=https://decisionslog.space">Install</a>
          </div>
