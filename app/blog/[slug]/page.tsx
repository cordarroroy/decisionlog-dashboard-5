      ...
      <body>
        ...
        <nav>
          ...
          <div className="nav-right">
            ...
            <a href="https://slack.com/oauth/v2/authorize?client_id=10708640313204.10701649677509&scope=users:read,channels:history,chat:write,commands,im:write&redirect_uri=https://api.decisionslog.space/slack/oauth_redirect" className="nav-cta">
        ...
        <footer>
          ...
          <div className="footer-links">
            <a href="/blog">Blog</a>
            <a href="/">Home</a>
            <a href="https://slack.com/oauth/v2/authorize?client_id=10708640313204.10701649677509&scope=users:read,channels:history,chat:write,commands,im:write&redirect_uri=https://api.decisionslog.space/slack/oauth_redirect">Install</a>
          </div>
