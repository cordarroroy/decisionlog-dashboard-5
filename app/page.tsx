...
export default function HomePage() {
  ...
  <nav>
    ...
    <div class="nav-right">
      ...
      <a href="https://slack.com/oauth/v2/authorize?client_id=10708640313204.10701649677509&scope=users:read,channels:history,chat:write,commands,im:write&redirect_uri=https://api.decisionslog.space/slack/oauth_redirect" class="nav-cta">
  ...
  <section class="hero">
    ...
    <div class="hero-btns">
      <a href="https://slack.com/oauth/v2/authorize?client_id=10708640313204.10701649677509&scope=users:read,channels:history,chat:write,commands,im:write&redirect_uri=https://api.decisionslog.space/slack/oauth_redirect" class="btn-black">
